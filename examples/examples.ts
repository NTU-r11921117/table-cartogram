...
const DND_ALIGNMENTS = [
  ...
  [
    {name: 'Lawful Evil', percent: 5.0, count: 50},
    {name: 'Neutral Evil', percent: 3.9, count: 39},
    {name: 'Chaotic Evil', percent: 1.7, count: 17},
  ],
];

const infColor = (val: any, idx: number) => ({val, color: idx % 2 ? 'red' : 'blue'});
...
const WIKI_CONFUSION_GRAM_OK_CLASSIFIER = [
  ...
  [
    {size: 1.0, show: 0},
    {size: 1.238313555, show: 1},
    {size: 1.373938769, show: 1},
  ],
];
...
const WIKI_CONFUSION_GRAM_BAD_CLASSIFIER = [
  [
    {size: 1.0, show: 8},
    {size: 1.891805812, show: 6},
    {size: 3.266785285, show: 13},
  ],
  [
    {size: 1.0, show: 0},
    {size: 1.891805812, show: 0},
    {size: 1.0, show: 0},
  ],
  [
    {size: 1.0, show: 0},
    {size: 1.0, show: 0},
    {size: 3.266785285, show: 0},
  ],
];
